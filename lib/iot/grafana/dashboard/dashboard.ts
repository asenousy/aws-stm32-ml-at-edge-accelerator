...
import { aws_secretsmanager, CustomResource, custom_resources, aws_lambda_nodejs, aws_lambda } from 'aws-cdk-lib';
...
export class Dashboard extends Construct {
  ...
  constructor(scope: Construct, id: string, props: DashboardProps) {
    ...
    const mlConfig = parse(readFileSync('mlops/pipelines/stm/stm32ai-modelzoo/audio_event_detection/scripts/deployment/user_config.yaml', 'utf8'));
